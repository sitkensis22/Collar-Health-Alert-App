...
- input4: 3 geese, median fix rate = 1h | 4h, tracking duration 1.5 years, gps, includes migration | includes simulated mortality_status, gps_fix_type raw, and collar_end_type fields, and simulates a mortality resurrection and gps resurrection event for testing purposes in 'input4_move2loc_LatLon.rds' dataset. The track data also includes a simulated field for scheduled_detachment_date to test that alert field.
