...
## Description
Generates and appends fields to data for 8 different types of alerts that were developed to monitor collar health: (1) mortality status, (2) mortality resurrection, (3) cluster analysis, (4) maximum net-squared displacement, (5) voltage levels, (6) GPS accuracy, (7) GPS transmission gaps, (8) the resurrection of a GPS tag or collar, and (9) scheduled tag release dates.
...
**Set mortality resurrection alert (`resurrection`):** This logical input acts as a switch to turn on mortality resurrection event monitoring. 
